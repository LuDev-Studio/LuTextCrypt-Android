...
public class AeskeyGeneratorActivity extends AppCompatActivity implements View.OnClickListener {
    Toolbar toolbar;

    private RadioButton radio_128bits;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aeskey_generator);
    ...
    private void initKomponenten() {
        ...
        radio_128bits = (RadioButton) findViewById(R.id.checkBox_128bits);
        radio_128bits.setOnClickListener(this);
        radio_128bits.setChecked(true);
    ...
    private void save() {
        ...
        File ordner_aes = new File(ordner_keys, algo);
        File secKey = new File(ordner_aes, fileName_secKey);
        if(!ordner_main.exists())
            ordner_main.mkdirs();
        if(!ordner_keys.exists())
            ordner_keys.mkdirs();
        if(!ordner_aes.exists())
            ordner_aes.mkdirs();
